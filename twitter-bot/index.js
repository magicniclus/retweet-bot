...
const keywords = ["#threejs", "#awwwards", "#webdesign", "#webgl", "#ui", "#ux"]
let keyValue = 0
const keywordsLength = keywords.length

function updateKeyWords (keywords){
  keyValue++
  if(keywords[keyValue-1] === undefined) keyValue = 0
  return keywords[keyValue - 1]
}
...
setInterval(main, Math.floor(Math.random() * (50000 - 5000 + 1)) + 5000);
